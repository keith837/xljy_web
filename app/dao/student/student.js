...
Student.queryPageByStudentId = function(studentId, startDate, start, pageSize, callback){
    var sql = "select * from (select A.studentId, 1 as dataType, A.leaveId, A.startDate,A.endDate,A.createDate,A.state,A.leaveDays,A.applyPeason,A.reason from XL_STUDENT_LEAVE A where A.state!=0 and A.startDate>=? and A.studentId=? ";
